...
st.markdown("""
    <div style='text-align: center; padding: 20px 0;'>
        <img src='https://raw.githubusercontent.com/Shunmathi007/bioloop/main/data/logo.png' width='150'>
        <h1 style='margin-top: 10px; color: #004d40;'>♻ BioLoop</h1>
        <p style='color: #00695c; font-size: 18px;'>Empowering Circular Economy for MSMEs</p>
    </div>
